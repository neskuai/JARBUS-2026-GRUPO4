...
> **Jarbus** es un sistema diseñado para el monitoreo de aforo en tiempo real en el transporte público. Utilizando un Arduino Uno Q con Linux integrado, 
---
<details>
